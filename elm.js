...
var author$project$DevTools$Model = function (model) {
	return {model: model};
};
var author$project$DevTools$RunMsg = function (a) {
	return {$: 'RunMsg', a: a};
};
...
var author$project$DevTools$encodeAction = F2(
		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'model',
					_export.encodeModel(action.model)),
					_Utils_Tuple2(
					'message',
					A2(
						elm$core$Maybe$withDefault,
						elm$json$Json$Encode$null,
						A2(elm$core$Maybe$map, _export.encodeMsg, action.message)))
				]));
	});
var elm$core$Basics$identity = function (x) {
	return x;
};
var author$project$DevTools$toDevTools = _Platform_outgoingPort('toDevTools', elm$core$Basics$identity);
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$map = _Platform_map;
var author$project$DevTools$init = F3(
	function (_export, initializer, flags) {
		var _n0 = initializer(flags);
		var model = _n0.a;
		var cmd = _n0.b;
		return _Utils_Tuple2(
			author$project$DevTools$Model(model),
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2(elm$core$Platform$Cmd$map, author$project$DevTools$RunMsg, cmd),
						author$project$DevTools$toDevTools(
						A2(
							author$project$DevTools$encodeAction,
							_export,
							{message: elm$core$Maybe$Nothing, model: model}))
					])));
	});
var author$project$DevTools$SetModel = function (a) {
	return {$: 'SetModel', a: a};
};
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$DevTools$fromDevTools = _Platform_incomingPort('fromDevTools', elm$json$Json$Decode$value);
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$map = _Platform_map;
var elm$json$Json$Decode$decodeValue = _Json_run;
var author$project$DevTools$subscriptions = F3(
	function (_export, subscriber, _n0) {
		var model = _n0.model;
		return elm$core$Platform$Sub$batch(
			_List_fromArray(
				[
					...
					author$project$DevTools$RunMsg,
					subscriber(model)),
					author$project$DevTools$fromDevTools(
					function (val) {
						var _n1 = A2(elm$json$Json$Decode$decodeValue, _export.decodeModel, val);
						if (_n1.$ === 'Err') {
							return author$project$DevTools$SetModel(model);
						} else {
							var _new = _n1.a;
							return author$project$DevTools$SetModel(_new);
						}
					})
				]));
	});
...
var author$project$DevTools$update = F4(
	function (_export, updater, msg, _n0) {
		var model = _n0.model;
		if (msg.$ === 'SetModel') {
			var imodel = msg.a;
			return _Utils_Tuple2(
				author$project$DevTools$Model(imodel),
				elm$core$Platform$Cmd$none);
		} else {
			var imsg = msg.a;
			var _n2 = A2(updater, imsg, model);
			var updated = _n2.a;
			var cmd = _n2.b;
			return _Utils_Tuple2(
				author$project$DevTools$Model(updated),
				elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							A2(elm$core$Platform$Cmd$map, author$project$DevTools$RunMsg, cmd),
							...
							A2(
								...
								_export,
								{
									message: elm$core$Maybe$Just(imsg),
									model: model
								}))
						])));
		}
...
var author$project$DevTools$view = F2(
	function (viewer, _n0) {
		var model = _n0.model;
		return A2(
			elm$html$Html$map,
...
var author$project$DevTools$element = function (cfg) {
	return elm$browser$Browser$element(
		{
			init: A2(author$project$DevTools$init, cfg._export, cfg.init),
			subscriptions: A2(author$project$DevTools$subscriptions, cfg._export, cfg.subscriptions),
			update: A2(author$project$DevTools$update, cfg._export, cfg.update),
			view: author$project$DevTools$view(cfg.view)
		});
};
var elm$json$Json$Decode$int = _Json_decodeInt;
var author$project$Main$decodeModel = elm$json$Json$Decode$int;
var elm$json$Json$Encode$int = _Json_wrap;
var author$project$Main$encodeModel = elm$json$Json$Encode$int;
...
var author$project$Main$main = author$project$DevTools$element(
	{
		_export: {decodeModel: author$project$Main$decodeModel, encodeModel: author$project$Main$encodeModel, encodeMsg: author$project$Main$encodeMsg},
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"DevTools.Msg Basics.Int Main.Msg","aliases":{},"unions":{"DevTools.Msg":{"args":["model","msg"],"tags":{"SetModel":["model"],"RunMsg":["msg"]}},"Main.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[],"Reset":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));